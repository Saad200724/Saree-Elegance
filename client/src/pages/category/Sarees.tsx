    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative h-[40vh] w-full overflow-hidden bg-gray-900">
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 flex flex-col justify-center items-center text-white text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 font-heading">Sarees</h1>
          <p className="text-lg max-w-2xl opacity-90">Timeless elegance woven into every thread. Explore our exclusive silk and designer saree collection.</p>
        </div>
      </section>
